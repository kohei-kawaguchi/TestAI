...
1. **Input artifacts**: Describe how to load the calibrated demand and cost parameters, as well as any solver outputs (e.g., equilibrium price functions or markup fixed-point objects).
...
An instruction-only Quarto report that mirrors the flow of the MDP simulator but focuses solely on static oligopoly market simulations. Juniors will fill in all code, figures, and tables.
