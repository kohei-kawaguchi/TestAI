...
$$
u_j = \delta_j - \alpha p_j + \varepsilon_j, \quad \delta_j = X_j' \beta,
$$

where $p_j$ is price, $\alpha > 0$ is the marginal utility of income parameter, $\beta$ is a demand-parameter vector, and $\varepsilon_j$ is an idiosyncratic taste shock. For the outside option, utility is normalized as
